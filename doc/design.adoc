...
To learn more about the manager to embed in your Go application directory, see the link:quick-start.md[Quick Start] and link:https://pkg.go.dev/github.com/cybergarage/go-job[Go Reference] documentation.
...
To learn more about the server component, see the link:grpc-api.md[gRPC API] and link:cmd/cli/job-cli.md[CLI (jobctl)] documentation.
