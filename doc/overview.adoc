...
`go-job` supports special arguments related to the job instance, such as link:https://pkg.go.dev/context[context.Context], link:https://pkg.go.dev/github.com/cybergarage/go-job/job#Manager[job.Manager], link:https://pkg.go.dev/github.com/cybergarage/go-job/job#Worker[job.Worker], and link:https://pkg.go.dev/github.com/cybergarage/go-job/job#Instance[job.Instance].
