...
The link:./cmd/cli/jobctl.md[Jobctl CLI] provides a command-line interface to interact with the gRPC API. The following methods are available:
...
For more details, see the link:./cmd/cli/jobctl.md[Jobctl CLI] documentation.
