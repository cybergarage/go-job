...
For more details about the `Store` interface and how to extend it, see the link:design.md[Design and Architecture] and link:plugin-guide.md[Extension Guide] documentation.
