...
`go-job` allows you to use special arguments in your job functions, such as link:https://pkg.go.dev/context[context.Context], link:https://pkg.go.dev/github.com/cybergarage/go-job/job#Manager[job.Manager], link:https://pkg.go.dev/github.com/cybergarage/go-job/job#Worker[job.Worker], and link:https://pkg.go.dev/github.com/cybergarage/go-job/job#Instance[job.Instance].  
These arguments let you control job execution and access useful job-related information.
