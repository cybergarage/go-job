...
| Plugin Name    | Kind                   | Description                     |
|----------------|------------------------|---------------------------------|
| HistoryCleaner | system.history.cleaner | Deletes old job history records |
| LogCleaner     | system.log.cleaner     | Deletes old job log records     |
...
Last updated 2025-08-25 21:51:00 +0900
